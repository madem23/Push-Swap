...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/04/25 18:22:08 by mdemma            #+#    #+#             */
/*   Updated: 2022/04/25 18:22:11 by mdemma           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int ac, char **av)
{
	...
	t_list		*stack_b;
	t_stacks	*stacks;
	int			init_size_stack_a;
	int			init_size_stack_b;
	...
	stacks->lst_size = 0;
	stacks->a_size = &init_size_stack_a;
	stacks->b_size = &init_size_stack_b;
	stacks->stack_a = &stack_a;
	stacks->stack_b = &stack_b;
	if (!ft_parsing(ac, av, stacks))
		return (0);
	*(stacks->a_size) = stacks->lst_size;
